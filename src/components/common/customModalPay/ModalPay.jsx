  ...
  return (
    <div>
      <Box sx={style}>
        ...
        {/* ACA EN REALIDAD VA MAPEADO LO QUE ME TRAIGO DE LA DB */}
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <img src={order.items[0].image.url} width={60} height={60} />
                  <Box sx={{ display: "flex", flexDirection: "column" }}>
                    <h4>{order.items[0].subname}</h4>
                    <Typography variant="body2" sx={{ opacity: 0.5 }}>
                      ${order.items[0].price}
                    </Typography>
                  </Box>
                </Box>
                <h5 style={{ opacity: 0.5 }}>x{order.items[0].quantity}</h5>
              </Box>
              <Divider
                color="#000"
                width="90%"
